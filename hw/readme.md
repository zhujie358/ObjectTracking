...
8 | `kalman_filter` | Implment the Kalman filter equations in hardware. The module will take the meausred (x,y) position and produce an improved (x',y') position based on the theoretical model and covariance matrix. | Complete
